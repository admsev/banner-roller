...
1. bundle && rake db:migrate && rails s

3. User email: "example@example.com", password: "secret"

2. We use guard for rspec.
...
3. Sorry there's not so much time for rspec. Please see examples in /spec. I know, tests first in real life.

4. No time for candy bootstrap forms, sorry :)

== TODO

1. Candy Bootstrap forms for sites, banners, devise

2. Of course, more specs
